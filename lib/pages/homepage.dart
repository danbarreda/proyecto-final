...
const MISION =
    "Permitir el acceso de recursos\neducativos a cualquier usuario  de la\nUniversidad Metropolitana, que\noptimice y asegure el proceso de\nintercambio, venta, alquiler y\nvisualización de material. Se busca\nincrementar el conocimiento por\nmedios más amigables y estrechar la\ncolaboración entre los usuarios .";
const VISION =
    "Generar una nueva plataforma digital\ncolaborativa que aportará \nconocimientos dentro de la Unimet, \nformando una cultura universitaria de \nsolidaridad y reutilización de \nrecursos.  Y además ser  lograr la \neliminación de barreras de acceso a \ninformación.";

const MISION1 =
    "Permitir el acceso de recursos educativos a cualquier usuario  de la Universidad Metropolitana, que optimice y asegure el proceso de intercambio, venta, alquiler y visualización de material. Se busca incrementar el conocimiento por medios más amigables y estrechar la colaboración entre los usuarios .";
const VISION1 =
    "Generar una nueva plataforma digital colaborativa que aportará conocimientos dentro de la Unimet,  formando una cultura universitaria de solidaridad y reutilización de recursos.  Y además ser  lograr la eliminación de barreras de acceso a información.";
      ...
      child: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Ecosistema colaborativo con material vigente y verificado",
          ...
          Stack(
            children: [
              ...
              Padding(
                padding: EdgeInsetsGeometry.fromLTRB(15, 30, 30, 30),
                child: Column(
                  spacing: 15,
                  children: [
                    Row(
                ...
                Row(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Image(
                          image: AssetImage("assets/images/logounimet.png"),
                          height: 80,
                        ),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.all(20),
                    child: Text(
                      "Ecosistema colaborativo con\n material vigente y verificado",
                      style: GoogleFonts.museoModerno(
                        color: Colors.white,
