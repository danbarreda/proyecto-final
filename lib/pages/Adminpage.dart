                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final String nombre = solicitud['nombreCompleto'] ?? 'Sin Nombre';
                            final String correo = solicitud['emailSolicitante'] ?? 'Sin Correo';
                            if (solicitud['estado'].toString().trim().toLowerCase() == 'rechazada') {
                                      ...
                                      onPressed: () {
                                        showDialog(
                                          ...
                                          builder: (context) => AlertDialog(
                                            ...
                                            content: Text(
                                              "¿Estás seguro de rechazar la solicitud de '${nombre}'?",
                                            ),
                                            actions: [
                                              TextButton(
                                                onPressed: () =>
                                              ...
                                              TextButton(
                                                onPressed: () async {
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      "Rechazando solicitud de '${nombre}'...",
                                                    ),
                                                  );
